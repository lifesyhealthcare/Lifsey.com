...
<html lang="en">
	...
	<meta charset="utf-8">
		...
		<link href="assets/css/default/style2.css" rel="stylesheet">
	...
	<body>
		...
		<!-- 1st section start -->
		<section id="promo-9" class="content-block promo-1 min-height-600px bg-offwhite">
			<div class="container" >
				<div class="row">
		...
		<section id="content-1-9" class="content-1-9 content-block">
            <div class="container"> 
                <div class="underlined-title">
                    ...
                    <button class="btn" type="button"><a href="../../templates/Prediction.html" target="_blank"> Predict Your Disease</a></button>
                </div>
                </div>
					</section>
		<!-- forth section end -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="adminlogin.php">Doctors Login</a> </li>
            </ul>
          </div>
